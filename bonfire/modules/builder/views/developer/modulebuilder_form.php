...
<div class='module-builder'>
    <p class="intro"><?php echo lang('mb_create_note'); ?></p>
    ...
    <div class="admin-box">
        ...
        <fieldset id="module_details">
            ...
            <div class="control-group<?php echo form_error('module_name') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input name="module_name" id="module_name" type="text" value="<?php echo set_value("module_name"); ?>" placeholder="<?php echo lang('mb_form_mod_name_ph'); ?>" autocomplete="off" />
            ...
            <div class="control-group mb_advanced<?php echo form_error('module_description') ? ' error' : ''; ?>">
                ...
                <div class="controls">
                    <input name="module_description" id="module_description" type="text" value="<?php echo set_value("module_description", lang('mb_form_mod_desc_ph')); ?>" placeholder="<?php echo lang('mb_form_mod_desc_ph'); ?>" autocomplete="off" />
            ...
            <div class="control-group mb_advanced">
                ...
                <div class="controls" aria-labelledby="contexts_label" role="group">
                    <select name="contexts" id="contexts">
                        <?php foreach ($availableContexts as $context): ?>
                        <option value="<?php echo $context; ?>"><?php echo ucwords($context); ?></option>
                        <?php endforeach;?>
                        <option value="public"><?php echo lang('mb_form_public'); ?></option>
                    </select>
                </div>
            </div>
            ...
            <div class="control-group mb_advanced">
                ...
                <div class="controls">
                    <select name="role_id" id="role_id">
                        ...
                        <option value="<?php echo $role['role_id']; ?>" <?php echo $defaultRoleWithFullAccess == $role['role_id'] ? ' selected="selected"' : ''; ?>><?php echo $role['role_name']; ?></option>
                        <?php endforeach;?>
                    </select>
                </div>
            </div>
            ...
            <div class="control-group mb_advanced">
                <div class="controls">
                    <label for="log_user" class="checkbox">
                        <input type='checkbox' name="log_user" id="log_user" value='1' <?php echo set_checkbox('log_user', 1); ?> checked />
            ...
            <div class="control-group mb_advanced">
                <div class="controls">
                    <label for="use_soft_deletes" class="checkbox">
                        <input type='checkbox' name="use_soft_deletes" id="use_soft_deletes" value='1' <?php echo set_checkbox('use_soft_deletes', 1); ?> checked />
            ...
            <div class="control-group mb_advanced">
                <div class="controls">
                    <label for="use_created" class="checkbox">
                        <input type='checkbox' name="use_created" id="use_created" value='1' <?php echo set_checkbox('use_created', 1); ?> checked />
            ...
            <div class="control-group mb_advanced">
                <div class="controls">
                    <label for="use_modified" class="checkbox">
                        <input type='checkbox' name="use_modified" id="use_modified" value='1' <?php echo set_checkbox('use_modified', 1); ?> checked />
        ...
        <div id="all_fields">
            ...
            <fieldset id="field<?php echo $count; ?>_details">
                ...
                <div class="control-group<?php echo form_error($viewFieldLabel) ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="<?php echo $viewFieldLabel; ?>" id="<?php echo $viewFieldLabel; ?>" type="text" class="view_field_label" data-count="<?php echo $count; ?>" value="<?php echo set_value($viewFieldLabel, isset($existing_table_fields[$count]) ? ucwords(str_replace('_', ' ', $existing_table_fields[$count]['name'])) : ''); ?>" placeholder="<?php echo lang('mb_form_label_ph'); ?>" autocomplete="off" />
                ...
                <div class="control-group<?php echo form_error($viewFieldName) ? ' error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="<?php echo $viewFieldName; ?>" id="<?php echo $viewFieldName; ?>" type="text" class="view_field_name" data-count="<?php echo $count; ?>" value="<?php echo set_value($viewFieldName, isset($existing_table_fields[$count]) ? $existing_table_fields[$count]['name'] : ''); ?>" maxlength="30" placeholder="<?php echo lang('mb_form_fieldname_ph'); ?>" autocomplete="off" />
                ...
                <div class="control-group<?php echo form_error($dbFieldLength) ? 'error' : ''; ?>">
                    ...
                    <div class="controls">
                        <input name="<?php echo $dbFieldLength; ?>" id="<?php echo $dbFieldLength; ?>" type="text" value="<?php echo set_value($dbFieldLength, $default_max_len); ?>" placeholder="<?php echo lang('mb_form_length_ph'); ?>" autocomplete="off" />
