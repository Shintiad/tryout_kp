<style type="text/css">
    ...
    #ci-profiler-menu-open img {
        display: block;
    }

    #ci-profiler-menu-open:hover {
    ...
    #ci-profiler-menu a:first-child img {
        vertical-align: middle;
        margin-bottom: 2px;
        cursor: default;
    }

    #ci-profiler-menu a:first-child:hover,
    #ci-profiler-menu a:last-child:hover {
    ...
    #ci-profiler-menu-time:hover,
    #ci-profiler-menu-time:focus,
    #ci-profiler-menu-time.current,
    ...
    #ci-profiler-menu-memory:hover,
    #ci-profiler-menu-memory:focus,
    #ci-profiler-menu-memory.current,
    ...
    #ci-profiler-menu-queries:hover,
    #ci-profiler-menu-queries:focus,
    #ci-profiler-menu-queries.current,
    ...
    #ci-profiler-menu-vars:hover,
    #ci-profiler-menu-vars:focus,
    #ci-profiler-menu-vars.current,
    #ci-profiler-vars h2 {
    ...
    #ci-profiler-menu-files:hover,
    #ci-profiler-menu-files:focus,
    #ci-profiler-menu-files.current,
    ...
    #ci-profiler-menu-console:hover,
    #ci-profiler-menu-console:focus,
    #ci-profiler-menu-console.current,
    ...
    #ci-profiler-queries .hilight {
        font-weight: bolder;
        color: #3769a0 !important;
        font-style: normal;
    }

    #ci-profiler-vars .hilight {
        color: #d28c00 !important;
    }

    #ci-profiler-memory .hilight {
        color: #953fa1 !important;
    }

    #ci-profiler-benchmarks .hilight {
        color: #b72f09 !important;
    }

    #ci-profiler-console .hilight {
        color: #5a8616 !important;
    }
